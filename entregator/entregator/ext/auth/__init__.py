...
from entregator.ext.auth.admin import MyAdminIndexView, UserAdmin, CategoryAdmin, StoreAdmin, ItemsAdmin, OrderAdmin, OrderItemsAdmin, AddressAdmin
from entregator.ext.admin import admin
from entregator.ext.db.models import Address, Items, Order, OrderItems, User, Category, Store
